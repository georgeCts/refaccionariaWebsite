...
class Messages {
	...
	//MODELS
	const MODELS_CREATE_TITLE = "Nuevo modelo  agregado";
	const MODELS_CREATE_MESSAGE = "El nuevo modelo se agregó exitosamente.";
	const MODELS_EDIT_TITLE = "Modelo modificado";
	const MODELS_EDIT_MESSAGE = "El modelo se modificó exitosamente.";
