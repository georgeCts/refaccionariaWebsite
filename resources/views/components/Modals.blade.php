@section('components.Modals')
    <div class="modal fade" tabindex="-1" role="dialog" id="mdVendedores">
                        ...
                        <div class="row">
                            <div class="col-12 col-lg-6 bg-ngr text-center text-lg-left">
                                <div class="position-relative" style="z-index: 3">
                                    <img src="images/logo/logo.svg" alt="Fernandez" class="m40 w-90" style="max-width: 277px">
                                    <p>Eres un vendedor, ingresa para conocer las novedades.</p>
                                </div>
                            </div>
                            <div class="col-12 col-lg-6 bg-amr text-center">
                                <div class="position-relative" style="z-index: 3">
                                    <form action="https://fernandez.com.mx/admin/vendedores/login" method="POST" class="needs-validation" novalidate data-action="location.href='https://fernandez.com.mx/vendedores'">
                                        <input type="hidden" name="_token" value="0X5hezWrAfzANxIydq0F6WH3OcUAMS9gQKL8h8uB">
                                        <h3 class="text-uppercase">Ingresar</h3>
                                        <input type="email" name="email" placeholder="Correo" class="m20 form-control" required>
                                        <input type="password" name="password" placeholder="Contraseña" class="m20 form-control" required>
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-12 text-center">
                                ...
                                <form action="https://fernandez.com.mx/admin/postulantes/store" method="POST" class="needs-validation" novalidate data-action="$('#mdBolsaTrabajo').modal('hide')" enctype="multipart/form-data" >
                                    <input type="hidden" name="_token" value="0X5hezWrAfzANxIydq0F6WH3OcUAMS9gQKL8h8uB">
    ...
    <div class="modal fade" tabindex="-1" role="dialog" id="mdNewsletter" data-cookie="https://fernandez.com.mx/set/cookie">
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header dual">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                ...
                <div class="modal-body diagonal">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-12 col-lg-6 bg-ngr text-center text-lg-left">
                                <div class="position-relative" style="z-index: 3">
                                    <img src="{{ asset('images/encabezado/05-logo-madero.png') }}" alt="Fernández" class="m20 w-90" style="max-width: 277px">
                                    <p>Suscríbete para recibir las noticias más nuevas, productos, y eventos de Compañía Fernández.</p>
                            ...
                            <div class="col-12 col-lg-6 bg-amr text-center">
                                <div class="position-relative" style="z-index: 3">
                                    <form action="https://fernandez.com.mx/admin/boletin/store" method="POST" class="needs-validation" novalidate data-action="$('#mdNewsletter').modal('hide')">
                                        <input type="hidden" name="_token" value="0X5hezWrAfzANxIydq0F6WH3OcUAMS9gQKL8h8uB">
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-12 text-center">
                                ...
                                <p>Favor de llenar el siguiente formulario para capturar tus datos</p>
                                <form action="https://fernandez.com.mx/cotizacion/send" method="POST" class="needs-validation" novalidate data-action="$('#mdCotizaciones').modal('hide')" enctype="multipart/form-data" >
                                    <input type="hidden" name="_token" value="0X5hezWrAfzANxIydq0F6WH3OcUAMS9gQKL8h8uB">
                                    <input type="text" name="name" placeholder="*Nombre" class="m20 form-control" autocomplete="off" required>
                                    <input type="email" name="email" placeholder="*Correo" class="m20 form-control" autocomplete="off" required>
                                    <input type="text" name="phone_number" placeholder="*Teléfono" class="m20 form-control" autocomplete="off" required>
