...
@section('content')
    ...
    {!! Form::open(['route' => 'new-location', 'method' => 'POST']) !!}
        <div class="row">
            <div class="col-md-8 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Crear sucursal</h4>
                        <p class="card-description">La sucursal creada se mostrará en el listado de sucursales de la página web</p>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="latitude" name="latitude" placeholder="21.9876" />
                        </div>

                        <div class="form-group">
                            <label for="longitude">Longitud</label>
                            <input type="text" class="form-control" id="longitude" name="longitude" placeholder="-89.1234" />
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="whatsapp1" name="whatsapp1" placeholder="(999) 999-9999" />
                        </div>

                        <div class="form-group">
                            <label for="whatsapp2">Whatsapp 2</label>
                            <input type="text" class="form-control" id="whatsapp2" name="whatsapp2" placeholder="(999) 999-9999" />
                        </div>
