...
@section('content')
    ...
    {!! Form::open(['route' => 'new-post', 'method' => 'POST', 'files' => true]) !!}
        <div class="row">
            <div class="col-md-8 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Crear Publicaci&oacute;n</h4>
                        <p class="card-description">Información General</p>
                        
                        <div class="form-group">
                            <label for="txtTitle">Título</label>
                            <input type="text" class="form-control" id="txtTitle" name="txtTitle" placeholder="Título del post" required />
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="txtExcerpt" name="txtExcerpt" rows="2" required></textarea>
                        </div>
