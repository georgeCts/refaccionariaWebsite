        ...
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-description">Lista de categorias que serán mostrados en la web</p>
                            ...
                            <tbody>
                                @foreach($lstCategories as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/panel/categorias/categoria-editar/{{ $item->id }}" class="btn btn-sm btn-warning">Editar</a>
                                            <a href="/panel/categorias/eliminar/{{ $item->id }}" class="btn btn-sm btn-danger">Eliminar</a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
